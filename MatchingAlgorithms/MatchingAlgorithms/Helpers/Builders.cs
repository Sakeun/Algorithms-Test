...
public class Builders
{
    ...
    public List<Vector> AvailableVectorsBuilder()
    {
        return new List<Vector>
        {
            ...
            new Vector { Name = "A8", Keywords = new []{ "K1", "K3", "K5", "K9" }},
            new Vector { Name = "A10", Keywords = new []{ "K2", "K3", "K4", "K7", "K10" }},
            new Vector { Name = "A11", Keywords = new []{ "K1", "K2", "K5", "K8" }},
            new Vector { Name = "A12", Keywords = new []{ "K3", "K6", "K7", "K9" }},
            new Vector { Name = "A13", Keywords = new []{ "K1", "K4", "K6", "K8" }},
            ...
            new Vector { Name = "A21", Keywords = new []{ "K3", "K5", "K6", "K9" }},
            new Vector { Name = "A22", Keywords = new []{ "K1", "K2", "K4", "K8" }},
            ...
            new Vector { Name = "A28", Keywords = new []{ "K4", "K5", "K7", "K10" }},
            new Vector { Name = "A29", Keywords = new []{ "K1", "K3", "K6", "K9" }},
            ...
            new Vector { Name = "A33", Keywords = new []{ "K1", "K2", "K4", "K8" }},
            new Vector { Name = "A35", Keywords = new []{ "K1", "K4", "K6", "K10" }},
            ...
            new Vector { Name = "A43", Keywords = new []{ "K3", "K5", "K6", "K9" }},
